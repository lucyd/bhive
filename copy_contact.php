...
<div class="container">
	<div id="content" style="width:100%; padding-top:2em">
		<div class="title" style="padding-bottom:1.5em">
			<h2>Electronics Play School</h2>
		</div>
		<table style="padding-left:0.7em">
			<tr>
			<td width="100%">
				<img src="images/contact_page.jpg" height="70%" align="center" style="horizontal-align:center">
			</td>
			</tr>
			<tr>
			<td>
			<div class="editable" contenteditable="true" filename="contact_page_1.txt" >
				<p style="padding-top:2em; padding-left:1em">
				<?php
					echo file_get_contents("contact_page_1.txt");
				?>
				</p>
			</div>
			</td>
			...
			<tr>
			<td>
			<div class="editable" contenteditable="true" filename="contact_page_2.txt" >
				<p style="padding-top:0em; padding-left:1em">
				<?php
					echo file_get_contents("contact_page_2.txt");
				?>
				</p>
			</div>
			</td>
			...
			<tr>
			<td>
			<div class="editable" contenteditable="true" filename="contact_page_3.txt" >
				<p style="padding-top:0em; padding-left:1em">
				<?php
					echo file_get_contents("contact_page_3.txt");
				?>
				</p>
			</div>
			</td>
