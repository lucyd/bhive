...
<div class="container">
	<div id="content" style="width:100%; padding-top:2em">
		...
		<table style="padding-left:0.7em">
			<tr>
			<td>
			<div class="editable" contenteditable="true" filename="ASIC_page_intro.txt" >
				<p>
				<?php
					echo file_get_contents("ASIC_page_intro.txt");
				?>
				</p>
			</div>
			</td>
			<td rowspan="3" style="vertical-align:top; padding-left: 4em">
				<img src="images/ASIC_page_img.jpg" height="25%" width="70%">
			</td>
			</tr>
			<tr>
			<td>
				...
				<ol style="list-style:square; padding-top: 1em; padding-left:2em">
				<div class="editable" contenteditable="true" filename="ASIC_page_1.txt" >
					<?php
						echo file_get_contents("ASIC_page_1.txt");
					?>
				</div>
			...
			<td>
				...
				<ol style="list-style:square; padding-top: 1em; padding-left:2em">
				<div class="editable" contenteditable="true" filename="ASIC_page_2.txt" >
					<?php
						echo file_get_contents("ASIC_page_2.txt");
					?>
				</div>
				</ol>
			</td>
