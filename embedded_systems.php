...
<div class="container">
	<div id="content" style="width:100%; padding-top:2em">
		<div class="title" style="padding-bottom:1.5em">
			<h2>Embedded Systems Design</h2>
		</div>
		<table style="padding-left:0.7em">
			<tr>
			<td width="60%">
				<ol style="list-style:square; padding-top: 1em; padding-left:2em">
				<div class="editable" contenteditable="true" filename="embedded_systems_page_1.txt" >
					<?php
						echo file_get_contents("embedded_systems_page_1.txt");
					?>
				</div>
				</ol>
			</td>
			<td rowspan="2" style="vertical-align:top;padding-left:2em">
				<img src="images/embedded_systems_page.jpg" width="90%">
			</td>
			</tr>
		</table>
		</div>
