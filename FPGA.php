	...
	<div id="content" style="width:100%; padding-top:2em">
		...
		<table style="padding-left:0.7em">
			...
			<td width="60%">
				...
				<div class="editable" contenteditable="true" filename="FPGA_page_1.txt" >
					<?php
						echo file_get_contents("FPGA_page_1.txt");
					?>
				</div>
				</ol>
			</td>
			<td rowspan="2" style="vertical-align:top;">
				<img src="images/FPGA_page.jpg" width="90%">
			</td>
			</tr>
			<tr>
			<td>
				...
				<ol style="list-style:square; padding-top: 1em; padding-left:2em">
				<div class="editable" contenteditable="true" filename="FPGA_page_2.txt" >
					<?php
						echo file_get_contents("FPGA_page_2.txt");
					?>
				</div>
				</ol>
			</td>
