	...
	<div id="content" style="width:100%; padding-top:2em">
		...
		<table style="padding-left:0.7em">
			...
			<td width="60%">
				...
				<div class="editable" contenteditable="true" filename="PCB_page_1.txt" >
					<?php
						echo file_get_contents("PCB_page_1.txt");
					?>
				</div>
				</ol>
			</td>
			<td rowspan="2" style="vertical-align:top;padding-left:3.5em">
				<img src="images/PCB_page.jpg" width="70%">
			</td>
			</tr>
		</table>
		</div>
