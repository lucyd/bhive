...
<div class="container">
	<div id="content" style="width:100%; padding-top:2em">
		...
		<table style="padding-left:0.7em">
			<tr>
			<td align="center">
				<img src="images/management_page.jpg" height="60%">
			</td>
			</tr>
			<tr>
			<td>
			<div class="editable" contenteditable="true" filename="management_page.txt" >
				<p>
				<?php
					echo file_get_contents("management_page.txt");
				?>
				</p>
			</div>
			</td>
